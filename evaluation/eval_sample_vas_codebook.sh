...
if [[ "$DATASET" == "VGGSound" ]]; then
    ...
    SPEC_DIR_PATH="/juno/u/jyau/regnet/data/features/vas/dog/melspec_10s_22050hz/"
    RGB_FEATS_DIR_PATH="/juno/u/jyau/regnet/data/features/vas/dog/feature_rgb_bninception_dim1024_21.5fps"
    FLOW_FEATS_DIR_PATH="/juno/u/jyau/regnet/data/features/vas/dog/feature_flow_bninception_dim1024_21.5fps"
    SAMPLES_FOLDER="reproduce_vas_dog"
    #SPLITS="\"[validation, ]\""
    SAMPLER_BATCHSIZE=4
